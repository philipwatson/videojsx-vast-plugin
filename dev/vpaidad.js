...
VpaidVideoPlayer.prototype.loadedMetadata_ = function() {
  ...
  console.log(this.videoSlot_.duration);
...
VpaidVideoPlayer.prototype.updateVideoSlot_ = function() {
  if (!this.videoSlot_) {
    ...
    this.videoSlot_.id = 'internal_video';
    this.videoSlot_.style.cssText = 'position:absolute; top:0; z-index:2 !important; ';
  ...
  if (!foundSource) {
    console.log('Unable to find a source video.');
