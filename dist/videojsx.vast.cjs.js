...
class UI extends external_video_js_namespaceObject.EventTarget {
...
class VPAIDHandler {
  ...
  constructor(player, options) {
    this.#player = player;
    this.#options = options;
    this.#eventTarget = new external_video_js_namespaceObject.EventTarget();
  }
...
const Plugin = external_video_js_namespaceObject.getPlugin('plugin');
...
class VastPlugin extends Plugin {
  ...
  constructor(player, options) {
    ...
    const mergeOptionsFunction = parseInt(external_video_js_namespaceObject.VERSION, 10) >= 8 ? external_video_js_namespaceObject.obj.merge : external_video_js_namespaceObject.mergeOptions;
...
external_video_js_namespaceObject.registerPlugin('vast', VastPlugin);
...
/******/ })()
;
//# sourceMappingURL=videojsx.vast.cjs.js.map